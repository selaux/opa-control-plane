package global.systemtypes["terraform:2.0"].library.provider.azure.kics.rdp_is_exposed_to_the_internet.v2

import data.global.systemtypes["terraform:2.0"].library.provider.azure.kics_libs.terraform as tf_lib

rdp_is_exposed_to_the_internet_inner[result] {
	...
	result := {"documentId": input.document[i].id, "issueType": "IncorrectValue", "keyActualValue": sprintf("'azurerm_network_security_rule.%s.destination_port_range' might be 3389", [var0]), "keyExpectedValue": sprintf("'azurerm_network_security_rule.%s.destination_port_range' cannot be 3389", [var0]), "resourceName": tf_lib.get_resource_name(resource, var0), "resourceType": "azurerm_network_security_rule", "searchKey": sprintf("azurerm_network_security_rule[%s].destination_port_range", [var0])}
}
...
# version: v1
# title: "KICS: RDP Is Exposed To The Internet"
# description: >-
...
# resource-type: ""
# custom:
#   id: "azure.kics.rdp_is_exposed_to_the_internet"
#   impact: ""
#   remediation: ""
#   severity: "high"
#   resource_category: ""
...
rdp_is_exposed_to_the_internet_snippet[violation] {
	rdp_is_exposed_to_the_internet_inner[inner] with input as data.global.systemtypes["terraform:2.0"].library.utils.v1.transformed_input
