package global.systemtypes["terraform:2.0"].library.provider.azure.postgres_db.backup_disabled.v1
...
# version: v1
# title: "Azure: Postgres: Prohibit backup disabled Postgres database"
# description: >-
#   Require Azure/Postgres database to have Geo-redundant backup enabled.
# severity: "medium"
# platform: "terraform"
# resource-type: "azure-postgres"
# custom:
#   id: "azure.postgres_db.backup_disabled"
#   impact: ""
#   remediation: ""
#   severity: "medium"
#   resource_category: ""
...
#       max: "v3"
#   rule_targets:
#     - { scope: "resource", service: "postgresql", name: "postgresql_server", identifier: "azurerm_postgresql_server", argument: "geo_redundant_backup_enabled" }
# schema:
#   decision:
#     - type: rego
#       key: allowed
...
prohibit_backup_disabled_postgres_db_server[violation] {
...
backup_disabled_database[violation] {
	azure_database := util.postgres_server_resource_changes[_]
	azure_database.change.after.geo_redundant_backup_enabled == false

	violation := {
		"message": sprintf("Postgres Database %v without geo redundant backup are prohibited.", [azure_database.address]),
