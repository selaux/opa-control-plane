package global.systemtypes["terraform:2.0"].library.provider.aws.elasticsearch.node_to_node_encryption.test_v1

import data.global.systemtypes["terraform:2.0"].library.provider.aws.elasticsearch.node_to_node_encryption.v1

test_node_to_node_encryption_elasticsearch_good {
	enabled := true
	in := input_elasticsearch_domain(enabled)
	actual := v1.prohibit_elasticsearch_domains_with_disabled_node_to_node_encryption with input as in

	count(actual) == 0
}

test_node_to_node_encryption_elasticsearch_bad {
	enabled := false
	in := input_elasticsearch_domain(enabled)
	actual := v1.prohibit_elasticsearch_domains_with_disabled_node_to_node_encryption with input as in
...
test_node_to_node_encryption_elasticsearch_not_configured {
		...
		"planned_values": {"root_module": {"child_modules": [{
			"resources": [{
				...
				"values": {
					...
					"elasticsearch_version": "7.10",
					"log_publishing_options": [],
					"node_to_node_encryption": [{"enabled": value}],
					"snapshot_options": [],
					"tags": {"Domain": "TestDomain"},
					"tags_all": {"Domain": "TestDomain"},
					"timeouts": null,
