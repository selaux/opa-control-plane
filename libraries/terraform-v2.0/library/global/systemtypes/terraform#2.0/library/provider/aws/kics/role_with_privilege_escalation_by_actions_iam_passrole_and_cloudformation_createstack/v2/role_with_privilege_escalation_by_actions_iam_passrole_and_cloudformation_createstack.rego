package global.systemtypes["terraform:2.0"].library.provider.aws.kics.role_with_privilege_escalation_by_actions_iam_passrole_and_cloudformation_createstack.v2

import data.global.systemtypes["terraform:2.0"].library.provider.aws.kics_libs.common as common_lib
import data.global.systemtypes["terraform:2.0"].library.provider.aws.kics_libs.terraform as tf_lib

role_with_privilege_escalation_by_actions_iam_passrole_and_cloudformation_createstack_inner[result] {
...
# version: v1
# title: "KICS: Role With Privilege Escalation By Actions 'cloudformation:CreateStack' And 'iam:PassRole'"
# description: >-
...
# resource-type: ""
# custom:
#   id: "aws.kics.role_with_privilege_escalation_by_actions_iam_passrole_and_cloudformation_createstack"
#   impact: ""
#   remediation: ""
#   severity: "medium"
#   resource_category: ""
...
role_with_privilege_escalation_by_actions_iam_passrole_and_cloudformation_createstack_snippet[violation] {
	role_with_privilege_escalation_by_actions_iam_passrole_and_cloudformation_createstack_inner[inner] with input as data.global.systemtypes["terraform:2.0"].library.utils.v1.transformed_input
