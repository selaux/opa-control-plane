package global.systemtypes["terraform:2.0"].library.provider.azure.mysql_db.backup_disabled.v1
...
# version: v1
# title: "Azure: MySQL: Prohibit backup disabled MySQL database"
# description: >-
#   Require Azure/MySQL database to have Geo-redundant backup enabled.
# severity: "medium"
# platform: "terraform"
# resource-type: "azure-mysql"
# custom:
#   id: "azure.mysql_db.backup_disabled"
#   impact: ""
#   remediation: ""
#   severity: "medium"
#   resource_category: ""
...
#       max: "v3"
#   rule_targets:
#     - { scope: "resource", service: "mysql", name: "mysql_server", identifier: "azurerm_mysql_server", argument: "geo_redundant_backup_enabled" }
# schema:
#   decision:
#     - type: rego
#       key: allowed
...
prohibit_backup_disabled_mysql_db_server[violation] {
...
backup_disabled_database[violation] {
	azure_database := util.mysql_server_resource_changes[_]
	azure_database.change.after.geo_redundant_backup_enabled == false

	violation := {
		"message": sprintf("MySQL Database %v without geo redundant backup is prohibited.", [azure_database.address]),
